...
export class AdminController {
  ...
  @Get('doctors/upload-url')
  @Roles(UserRole.ADMIN)
  @ApiOperation({ summary: 'Get upload URL for doctor profile photo (direct Azure upload)' })
  @ApiQuery({ name: 'filename', required: true, example: 'doctor-photo.jpg' })

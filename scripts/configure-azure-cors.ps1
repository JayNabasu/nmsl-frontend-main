...
az storage cors add `
  ...
  --origins "https://witty-beach-029599903.7.azurestaticapps.net" "https://happy-field-00ae4cb03.7.azurestaticapps.net" "https://www.nmsl.ng" "https://nmsl.ng" "http://localhost:3000" "http://localhost:3001" "http://localhost:5173" `
  --allowed-headers "*" `
  --exposed-headers "*" `
  --max-age 3600 `
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "       Allowed origins: https://witty-beach-029599903.7.azurestaticapps.net, https://www.nmsl.ng, http://localhost:3000"
